...
def analyze_candidate(
    ...
    """Backward-compatible functional API for one candidate."""
...
def run_deep_scan(
    ...
    """Backward-compatible functional API for the deep scan use case."""
